	...
	<div class="widget-box widget-color-blue2">
		...
		<div class="widget-body">
								...
								<table class="table table-bordered table-condensed table-striped">
									...
									<?php if (ON == config_get('enable_email_notification')) { ?>
										...
										<tr>
											...
											<td>
												<label class="inline">
													<input type="checkbox" class="ace input-sm" id="email-full-issue" name="email_full_issue" <?php check_checked($t_email_full_issue, ON); ?> />
													<span class="lbl"></span>
												</label>
											</td>
										</tr>
			...
			<div class="widget-toolbox padding-8 clearfix">
				<button form="account-prefs-update-form" class="btn btn-primary btn-white btn-round">
