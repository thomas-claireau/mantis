							...
							<div class="table-responsive">
								<table class="table table-bordered table-condensed table-striped">
									<tr>
										...
										<td>
											<input type="text" class="input-sm" id="platform" name="platform" size="32" maxlength="32" required />
										</td>
									</tr>
									<tr>
										<td class="category">
										...
										<td>
											<input type="text" class="input-sm" id="os" name="os" size="32" maxlength="32" required />
										</td>
									</tr>
									<tr>
										<td class="category">
										...
										<td>
											<input type="text" class="input-sm" id="os_build" name="os_build" size="16" maxlength="16" required />
										</td>
									</tr>
									<tr>
										<td class="category">
										...
										<td>
											<textarea id="description" name="description" class="form-control" cols="80" rows="8"></textarea>
										</td>
									</tr>
								</table>
							</div>
