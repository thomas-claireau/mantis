...
?>
	<canvas id="<?php echo $t_id, $s_id ?>" width="<?php echo $t_width ?>" height="<?php echo $t_height ?>" data-labels="<?php echo htmlspecialchars($t_json_labels, ENT_QUOTES) ?>" data-values="<?php echo htmlspecialchars($t_json_values, ENT_QUOTES) ?>">
	</canvas>
<?php
}
...
function graph_cumulative_bydate(array $p_metrics, $p_wfactor = 1)
{
	...
	$t_formatted_labels = array_map(function ($label) {
		return date('Ymd', $label);
	}, $t_labels);
	...
	$t_height = 400;
?>
	<canvas id="linebydate<?php echo $s_id ?>" width="<?php echo $t_width ?>" height="<?php echo $t_height ?>" data-labels="<?php echo htmlspecialchars($t_json_labels, ENT_QUOTES) ?>" data-opened-label="<?php echo $t_legend_opened ?>" data-opened-values="<?php echo htmlspecialchars($t_opened_values, ENT_QUOTES) ?>" data-resolved-label="<?php echo $t_legend_resolved ?>" data-resolved-values="<?php echo htmlspecialchars($t_resolved_values, ENT_QUOTES) ?>" data-still-open-label="<?php echo $t_legend_still_open ?>" data-still-open-values="<?php echo htmlspecialchars($t_still_open_values, ENT_QUOTES) ?>">
	</canvas>
<?php
