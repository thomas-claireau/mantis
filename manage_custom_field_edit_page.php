...
<?php echo string_attribute($t_definition['default_value']) ?>
									...
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-filter-by" name="filter_by" class="ace" value="1" <?php
									...
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-display-report" name="display_report" class="ace" value="1" <?php check_checked((bool)$t_definition['display_report']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-display-update" name="display_update" class="ace" value="1" <?php check_checked((bool)$t_definition['display_update']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-display-resolved" name="display_resolved" class="ace" value="1" <?php check_checked((bool)$t_definition['display_resolved']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-display-closed" name="display_closed" class="ace" value="1" <?php check_checked((bool)$t_definition['display_closed']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-require-report" name="require_report" class="ace" value="1" <?php check_checked((bool)$t_definition['require_report']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-require-update" name="require_update" class="ace" value="1" <?php check_checked((bool)$t_definition['require_update']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-require-resolved" name="require_resolved" class="ace" value="1" <?php check_checked((bool)$t_definition['require_resolved']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
									<tr>
										...
										<td>
											<label>
												<input type="checkbox" id="custom-field-require-closed" name="require_closed" class="ace" value="1" <?php check_checked((bool)$t_definition['require_closed']) ?> />
												<span class="lbl"></span>
											</label>
										</td>
									</tr>
