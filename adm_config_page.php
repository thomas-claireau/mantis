					...
					<div class="widget-main no-padding">
									...
									<fieldset>
											...
											<td>
												...
												?>
													<select id="config-user-id" name="user_id" class="input-sm">
														<option value="<?php echo ALL_USERS; ?>" <?php check_selected($t_option_user_id, ALL_USERS) ?>>
											...
											<td>
												...
												?>
													<select id="config-project-id" name="project_id" class="input-sm">
														<option value="<?php echo ALL_PROJECTS; ?>" <?php check_selected($t_option_project_id, ALL_PROJECTS); ?>>
										...
										<tr>
											...
											<td>
												...
												if ($t_modify) {
												?>
													<input type="text" name="config_option" class="input-sm" value="<?php echo string_display_line($t_option_id); ?>" size="64" maxlength="64" />
						...
						<div class="widget-toolbox padding-4 clearfix">
							...
							?>
								...
								<input type="submit" name="config_set" class="btn btn-primary btn-white btn-round" value="<?php echo $t_action_label; ?>" />
							<?php
							}
							?>
						</div>
