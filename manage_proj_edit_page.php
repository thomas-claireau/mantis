							...
							<table class="table table-bordered table-condensed table-striped">
								<fieldset>
									...
									<tr>
										...
										<td>
											<input type="text" id="project-name" name="name" required class="input-sm" size="60" maxlength="128" value="<?php echo string_attribute($t_row['name']) ?>" />
										</td>
									</tr>
									<tr>
										<td class="category">
									...
									<tr>
										...
										<td>
											<input type="checkbox" id="project-enabled" name="enabled" class="ace" <?php check_checked((int)$t_row['enabled'], ON); ?> />
											<span class="lbl"></span>
										</td>
									</tr>
									<tr>
										...
										<td>
											<input type="checkbox" id="project-inherit-global" name="inherit_global" class="ace" <?php check_checked((int)$t_row['inherit_global'], ON); ?> />
											<span class="lbl"></span>
										</td>
									</tr>
							...
							<fieldset>
								...
								<select name="subproject_id" class="input-sm" required>
									...
									foreach ($t_projects as $t_project) {
										if (
											in_array($t_project['id'], $t_all_subprojects) ||
										...
										<tbody>
											...
											foreach ($t_subproject_ids as $t_subproject_id) {
												...
												<tr>
													...
													<td class="center">
														<label>
															<input type="checkbox" class="ace" name="inherit_child_<?php echo $t_subproject_id ?>" <?php echo ($t_inherit_parent ? 'checked="checked"' : '') ?> />
															<span class="lbl"></span>
														</label>
													</td>
													<td class="center">
...
if (
	access_has_project_level(config_get('custom_field_link_threshold'), $f_project_id) &&
												...
												<td class="center">
													<form method="post" action="manage_proj_custom_field_update.php" class="form-inline">
														<fieldset>
															...
															<!--suppress HtmlFormInputWithoutLabel -->
															<input type="text" class="input-sm" name="sequence" size="2" value="<?php echo custom_field_get_sequence($t_field_id, $f_project_id) ?>" />
						...
						<form id="manage-project-users-form" method="post" action="manage_proj_user_update.php">
												...
												<td class="center">
													...
													?>
														<div class="checkbox no-padding no-margin editable_user_delete">
															<label>
																<input type="checkbox" name="user_access_delete[]" class="ace user_access_delete" value="<?php echo $t_user['id'] ?>" />
																<span class="lbl"></span>
															</label>
														</div>
													<?php
							...
							<div class="widget-toolbox padding-8 clearfix">
								...
								<div class="form-inline pull-right">
									...
									<input type="submit" name="btn-remove-all" class="btn btn-primary btn-white btn-round btn-xs" formaction="manage_proj_user_remove.php" value="<?php echo lang_get('remove_all_link') ?>" />
									...
									<table class="table table-bordered table-condensed table-striped">
										<fieldset>
											...
											<tr>
												...
												<td>
													<select id="project-add-users-username" name="user_id[]" class="input-sm" multiple="multiple" size="10" required>
														<?php
