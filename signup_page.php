							...
							<fieldset>
								...
								<label for="username" class="block clearfix">
									<span class="block input-icon input-icon-right">
										<input id="username" name="username" type="text" placeholder="<?php echo lang_get('username') ?>" size="32" maxlength="<?php echo DB_FIELD_SIZE_USERNAME; ?>" class="form-control autofocus">
								...
								<label for="email-field" class="block clearfix">
									<span class="block input-icon input-icon-right">
										<input id="email-field" name="email" type="text" placeholder="<?php echo lang_get('email_label') ?>" size="32" maxlength="64" class="form-control">
								...
								?>
									...
									<span id="captcha-input" class="input">
										...
										<object type="application/x-shockwave-flash" width="19" height="19" data="<?php echo $t_securimage_play; ?>">
