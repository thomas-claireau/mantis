					...
					<div class="table-responsive">
						...
						<table class="table table-bordered table-condensed table-striped">
							...
							?>
								<tr>
									...
									<td>
										...
										?>
											<input type="checkbox" id="bugnote_add_view_status" class="ace" name="private" <?php check_checked($t_default_reminder_view_status, VS_PRIVATE); ?> />
							...
							<tr>
								...
								<td>
									<textarea name="bugnote_text" cols="65" rows="10" class="form-control <?php echo $t_bugnote_class; ?>"></textarea>
								</td>
							</tr>
						</table>
