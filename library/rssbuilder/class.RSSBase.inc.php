...
abstract class RSSBase
{
	...
	protected $allowed_datatypes = array(
		'string', 'int', 'boolean',
		'object', 'float', 'array'
	);
	...
	{
		if (
			!in_array($type, $this->allowed_datatypes) ||
	...
	{
		if ($min_length == 0) {
			return (bool) (!ctype_space($string)) ? TRUE : FALSE;
		} // end if

		return (bool) (strlen(trim($var)) > $min_length) ? TRUE : FALSE;
	} // end function
